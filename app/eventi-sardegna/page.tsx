...
const HUB_PARAGRAPHS = [
  ...
  "Partiamo dalle ricerche vere. “Eventi oggi in Sardegna”, “cosa fare questo weekend”, “sagre a settembre”, “Autunno in Barbagia”: sono domande diverse, e per ognuna c’è una pagina. Da qui arrivi al giorno, al mese o alla festa grande senza passare da filtri nascosti.",
...
const HUB_FAQS = [
  {
    ...
    answer:
      "Apri gli eventi del weekend: concerti, sagre e feste paese da Nord a Sud, ordinati per data. Poi restringi per città se ti muovi in zona.",
  },
  {
