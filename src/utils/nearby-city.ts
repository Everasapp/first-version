...
const cityCoordinates: Record<string, { lat: number; lng: number }> = {
  ...
  Girasole: { lat: 39.9517, lng: 9.6625 },
  ...
  Seneghe: { lat: 40.0814, lng: 8.5331 },
  ...
  Guspini: { lat: 39.5403, lng: 8.6267 },
  ...
  Villacidro: { lat: 39.4567, lng: 8.6722 },
