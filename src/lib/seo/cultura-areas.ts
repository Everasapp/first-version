...
export const CULTURE_AREAS: CultureArea[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Le schede più ampie — musei, mestieri, cosa visitare — partono da Pattada, Castelsardo, Aggius, Tempio Pausania, Ozieri e Stintino. Gli altri comuni hanno già una pagina con eventi e collegamenti all’area.",
      },
    ],
  },
  {
